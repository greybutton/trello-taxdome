...
* на главной 
  ...
  * любой у кого есть эта ссылка
    ...
    * удалять колонку
    * создавать карточку на одной из колонок
      * у карточки только тайтл
    * удалять карточку
    * редактировать тайтл карточки
    * перемещать карточку между колонками
* *сохранением стейта в LocalStorage
* *развернутое приложение на любом хостинге (например: heroku.com)
* *тесты

Для верстальщиков:

* использование препроцессора (желателен Scss);
* модульность и консистентность стилей вместе с “ClientSide” компонентами;
* “general layout” сделать с помощью Grid Layout System + Flexbox;
* делать верстку без использования свойства float;
* сделать адаптивную верстку для мобильной платформы (iPhone 6/7/8), десктопной платформы (от 1024px до 1920px).

Плюс:

Большим плюсом будет выполнение пунктов отмеченных звездочкой (*).

Основные критерии при оценке: работоспособность, чистота, простота и читаемость кода.

Тестовое задание рассчитано приблизительно на 5 - 8 часов.

Технологии (возможны любые другие варианты по согласованию):

* back-end: rails 5 (minitest/rspec);
* database: postgres/mysql;
* front-end: React/Angular;
* markup/styling: HTML, Scss, PostCSS.
